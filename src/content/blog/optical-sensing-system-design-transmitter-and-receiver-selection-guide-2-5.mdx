---
title: 'Optical Sensing System Design – Part 2: Transmitter & Receiver Selection'
...
language: en
draft: false
heroImage: /images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/cover-natural-v2.png
...
This is Part 2 of the series. If you have not read it yet, you can start with [Part 1 – Foundations](/articles/optical-sensing-system-design-part-1-of-a-5-part-series/).
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 1](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-01.png)

*Figure 1 — Source: Hamamatsu Photonics, “Photodiodes Exposed,” 2024*
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 2](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-02.png)

*Figure 2 — Phototransistor operating principle and basic output circuit.*<br />
*Source: DigiKey, adapted from Mechapedia / Northwestern University.*
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 3](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-03.png)

*Figure 3 — Typical responsivity of Si, Ge and InGaAs photodetectors versus wavelength.*<br />
*Source: Azadeh, Fiber Optics Engineering, Springer.*
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 4](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-04.png)

*Figure 4 — Rise and fall time definition of a photodetector response.*<br />
*Source: Adapted from standard 10–90% photodetector timing definition.*
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 5](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-05.png)

*Figure 5 — Photodiode I–V characteristics under different illumination levels.*<br />
*Source: University of Arizona, Photodetectors lecture notes.*
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 6](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-06.png)

*Figure 6 — Photodetector field of view and incident-light geometry.*<br />
*Source: Adapted from standard photodetector FOV geometry.*
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 7](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-07.png)

*Figure 7 — Typical spectral responsivity of a silicon photodiode.*<br />
*Source: Adapted from S. O. Kasap, Optoelectronics.*
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 8](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-08.png)

*Figure 8 — BJT output characteristics, DC load line and Q-point.*<br />
*Source: IIT Bombay, EP215 Electronics Lab.*

## 2.3.4 Photodiode – Phototransistor Comparison Table

![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 9](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-09.png)
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 10](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-10.png)

**2.3.5.2 Circuits to Be Used**

In our tests, we will use the following receiver circuits.

![Optical Sensing System Design – Transmitter & Receiver Selection Guide (Part 2) - figure 11](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-11-v2.png)

*Figure 11 — Simplified photodiode and phototransistor output circuits.*<br />
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 12](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-12.png)

![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 13](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-13.png)

*Figure 13 — Simulated response comparison of SFH 213 FA photodiode and SFH 313 FA phototransistor for a 200-slot encoder at 300 rpm.*<br />
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 14](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-14.png)
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 15](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-15.png)

*Figure 15 — Illustrative comparison of phototransistor and photodiode outputs under ambient-light variation.*<br />
*Source: Author’s simulation.*
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 16](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-16.png)

*Figure 16 — Typical spectral output of an LED and a laser source.*<br />
*Source: Adapted from standard LED–laser spectral characteristics.*
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 17](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-17.png)

*Figure 17 — Laser beam divergence and diameter geometry.*<br />
*Source: Gentec-EO.*
...
![Optical Sensing System Design – Transmitter & Receiver Selection Guide (2/5) - figure 18](/images/articles/optical-sensing-system-design-transmitter-and-receiver-selection-guide-2-5/figure-18.png)

*Figure 18 — Gaussian beam propagation and focusing before and after a lens.*<br />
*Source: Gentec-EO, Beamage-M² User Manual.*
...
In the next section, we will no longer be designers who merely “sense” light—we will become designers who shape light.

Continue with [Part 3A – Optical Elements: Lenses](/articles/optical-sensing-system-design-optical-elements-part-3-of-5/).

## References

[1] Hamamatsu Photonics, *Photodiodes Exposed: Unlocking the Characteristics of These Crucial Sensors*, 2024.

[2] DigiKey, *How to Use Photodiodes and Phototransistors Most Effectively*.

[3] M. Azadeh, *Fiber Optics Engineering*, Springer.

[4] RSC, *Best Practices in the Measurement of Photodetectors*, 2022.

[5] S. O. Kasap, *Optoelectronics and Photonics: Principles and Practices*.

[6] IIT Bombay, *EP215 Electronics Lab – BJT Characteristics and Load Line*.

[7] Gentec-EO, *Laser Beam Divergence and Diameter*.

[8] Gentec-EO, *Beamage-M² User Manual*.
