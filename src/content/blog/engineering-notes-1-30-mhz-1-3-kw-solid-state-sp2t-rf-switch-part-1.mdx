...
\[
V_{RMS}pprox255\ 	ext{V}, \qquad
V_{PEAK}pprox361\ 	ext{V}, \qquad
I_{RMS}pprox5.1\ 	ext{A}
\]
...
\[
P_{COND}pprox5.1^2	imes0.058pprox1.5\ 	ext{W}
\]
...
\[
T=rac{1}{30\ 	ext{MHz}}pprox33.3\ 	ext{ns}
\]
...
\[
I_{Miller}=C_{GD}	imesrac{dV_{DS}}{dt}
\]
