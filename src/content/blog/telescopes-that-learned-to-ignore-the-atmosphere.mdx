...
language: en
draft: false
heroImage: /images/articles/telescopes-that-learned-to-ignore-the-atmosphere/cover-v2.png
...
*Figure 1 — Atmospheric turbulence distorting starlight before it reaches a ground-based telescope.*<br />
...
*Figure 2 — Shack–Hartmann wavefront sensor: a microlens array maps local wavefront tilts onto a detector.*<br />
*Source: Author's illustration, adapted from the standard Shack–Hartmann principle.*

The incoming wavefront (W) passes through a microlens array (MA), which divides the light into multiple sub-apertures. Each microlens focuses light onto the camera detector below. If the wavefront is perfectly flat, all focal spots appear at their expected positions. Atmospheric turbulence tilts different portions of the wavefront, causing these spots to shift. By measuring these tiny displacements, the system reconstructs the wavefront and determines how the atmosphere is distorting the incoming light.
...
Scientific cameras such as the [Hamamatsu ORCA-Fusion series](https://www.hamamatsu.com/us/en/product/cameras/scientific-cameras/orca-fusion.html) are examples of imaging systems designed for these demanding applications.
...
*Figure 3 — Closed-loop adaptive-optics architecture combining wavefront sensing, real-time control and a deformable mirror.*<br />
*Source: Author's illustration.*
...
*Figure 4 — Laser guide star generation in the mesospheric sodium layer.*<br />
*Source: Author's illustration, based on the laser-guide-star principle.*
...
- [ESO — Adaptive Optics overview](https://www.eso.org/public/teles-instr/technology/adaptive_optics/)
- [ESO — Four Laser Guide Star Facility](https://www.eso.org/public/teles-instr/technology/4lgsf/)
- [Hamamatsu Photonics — Astronomy applications](https://www.hamamatsu.com/us/en/applications/astronomy.html)
- [Subaru Telescope — Adaptive Optics](https://www.naoj.org/Observing/Telescope/OPTM/)
