...
*Figure 4 — Conducted-emission test setup showing the EUT, LISN, test receiver, and ground reference planes. Source: [Electrical Safety Testing Lab](https://electricalsafetytestinglab.com/2019/10/11/cispr-32-testing-labs/).*
...
*Figure 5 — CISPR/EN 55032 Class B conducted-emission quasi-peak and average limit curves. Source: Ege Test Center.*
...
*Figure 6 — Semi-anechoic chamber used for radiated-emission measurements. Source: CGS Test Center.*
...
*Figure 7 — Radiated-emission measurement setup with the EUT on a turntable and a height-adjustable receiving antenna. Source: [ScienceDirect](https://www.sciencedirect.com/topics/engineering/radiated-emission).*
...
*Figure 8 — CISPR 32 Class A and Class B radiated-emission limits at a 3 m test distance. Source: Ege Test Center.*
...
*Figure 9 — Electric-vehicle harmonic-current test setup with the charging harness, power supply, and harmonic analyzer. Source: [EUT Test](https://www.euttest.com/en/resources/ce-difference-automotive-industry-defense-part1.html).*
...
*Figure 10 — IEC 61000-4-2 ESD test table showing the horizontal coupling plate and ground reference plane. Source: [Transient Specialists](https://transientspecialists.com/blogs/blog/esd-test-setup-table-iec-61000-4-2).*
...
*Figure 11 — IEC 61000-4-4 EFT/Burst test setup using a capacitive coupling clamp. Source: [Accelonix](https://accelonix.nl/technical-note-iec-61000-4-4/).*
...
*Figure 12 — IEC 61000-4-5 surge test setup for interconnected equipment using isolation or decoupling networks. Source: [The EMC Shop](https://theemcshop.com/iec-61000-4-5-test-equipment/).*
...
*Figure 13 — Conducted RF immunity test setup using coupling/decoupling networks and an RF test generator. Source: [The EMC Shop](https://theemcshop.com/iec-61000-4-5-test-equipment/).*
...
*Figure 14 — Radiated RF immunity test setup in an anechoic chamber using a biconical antenna. Source: [In Compliance Magazine](https://incompliancemag.com/dipole-type-antennas-in-emc-testing-part-ii/).*
...
*Figure 15 — Voltage-dip, interruption, and power-failure immunity test setup. Source: [NoiseKen](https://www.noiseken.com/products/emc/vds/6369/).*
